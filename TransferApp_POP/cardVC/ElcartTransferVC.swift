...
class ElcartTransferVC: UIViewController, TransferProtocol, ValidCardProtocol {
    ...
    @objc func validateAmount(_ sender: UIButton) {
        ...
        if isCardNumberValid {
            if amount >= 20 {
                ...
                amountLabel.text = "Amount should be greater than or equal to $20"
